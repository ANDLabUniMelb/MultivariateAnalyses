...
def plot_ep_graph(
    ...
    *,
    ...
    plt.legend(
        ...
        bbox_to_anchor=(0.5, 0.075),  # (x=centre, y=5% below the plot)
        frameon=False,
        fontsize=10
    )
    if title:
...
spec = 'GCM_0723_pm_four_rois_striatum_main_effects_antvmpfc'
path = f"/Users/joecussen/Documents/Jobs/unimelb/projects/dcm_7t/results/{spec}"
...
df_A=df_A[df_A['Pp']>0.95].reset_index(drop=True)
...
condition_dict={
    1.0: 'Task',
    2.0: 'First Stim Animals',
    3.0: 'First Stim Weapons',
}
